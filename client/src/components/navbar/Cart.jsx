...
const Cart = () => {
    ...
    return ( 
        <>
            ...
            {cartOpen && <aside className="absolute z-30 bg-white top-24 xs:left-8 md:right-20 w-[28.5rem] rounded-xl h-80 shadow-2xl">
                ...
                <div className="w-full p-4 text-xl font-extrabold h-3/4 centered-col gap-y-4 text-dark/50">
                    ...
                    {!isEmpty && cartItems}
                    {!isEmpty && <button className="rounded-xl py-4 w-full text-lg font-bold bg-orange text-white easy-transition hover:cursor-pointer hover:bg-lightorange" >Checkout</button>}
                </div>
            </aside>}
        </>
     );
